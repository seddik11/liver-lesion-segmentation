...
def training(train_data_dir, save_name=""):
    ...
    with dpp.Pipeline(storage_name=save_name) as pipe:
        ...
        node = seg.medical.modified_load_all_slices(node, label_required=1, label_required_occ_rate=0.1, label_void_occ_rate=0.0, slice_type='axial', depth=5, single_label_slice=False)
